...
You may then use \verb7.. autofunction:: io.open 7 to read the signiture and docstring from the \verb7io.open()7 function. Similarily \begin{verbatim}
.. automodule:: io
   :members:
\end{verbatim} will document the whole \verb7io7 class.

\section{Formatting and markup}
Please follow this link \verb&http://sphinx-doc.org/rest.html& to find out how to add markups, if nessicary. The website is very complete and easy to follow.
